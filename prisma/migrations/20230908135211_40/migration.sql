...
-- AlterTable
ALTER TABLE "offered_course-section" ALTER COLUMN "maxCapacity" SET DEFAULT 0;
...
-- AddForeignKey
ALTER TABLE "offered_course_class_schedules" ADD CONSTRAINT "offered_course_class_schedules_offeredCourseSectionId_fkey" FOREIGN KEY ("offeredCourseSectionId") REFERENCES "offered_course-section"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
