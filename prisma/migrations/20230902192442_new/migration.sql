...
-- CreateTable
CREATE TABLE "offered_course-section" (
    "id" TEXT NOT NULL,
    "title" TEXT NOT NULL,
    ...
    CONSTRAINT "offered_course-section_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "offered_course" ADD CONSTRAINT "offered_course_semisterregistrationId_fkey" FOREIGN KEY ("semisterregistrationId") REFERENCES "semester_registrations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "offered_course-section" ADD CONSTRAINT "offered_course-section_offeredCourseId_fkey" FOREIGN KEY ("offeredCourseId") REFERENCES "offered_course"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "offered_course-section" ADD CONSTRAINT "offered_course-section_semisterregistrationId_fkey" FOREIGN KEY ("semisterregistrationId") REFERENCES "semester_registrations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
